...
Align with these style guides and checklists when applying the Rust style rule.

## Official Rust style guide

- **URL**: https://doc.rust-lang.org/beta/style-guide/index.html
- Line length 100, 4-space indent, block indent, trailing commas, blank lines, trailing whitespace, comments, attributes, small items.

## Rust API guidelines

- **URL**: https://rust-lang.github.io/api-guidelines/
- **Checklist**: https://rust-lang.github.io/api-guidelines/checklist.html
- Naming, interoperability, documentation, predictability, flexibility, type safety, dependability, debuggability, future proofing.
